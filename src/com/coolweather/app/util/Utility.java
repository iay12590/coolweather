...
public class Utility {
		...
		if(!TextUtils.isEmpty(response)){
			...
			if(allProvinces!=null&&allProvinces.length>0){
				for(String p:allProvinces){
					...
					coolWeatherDB.saveProvincce(province);
				}
				return true;
			}
		}
	...
	public static void handleWeatherResponse(Context context,String response){
		try {
			...
			response = response.substring(17, lengthResponse-1);
			...
			String temp1 = strTemp[0];
			String temp2 = strTemp[1];
			//String temp1 = weatherInfo.getString("temp1");
			//String temp2 = weatherInfo.getString("temp2");
			String weatherDesp = weatherInfo.getString("weather1");
			String publishTime = weatherInfo.getString("pm-pubtime");
	...
	/**
	 * 将服务器返回的所有天气信息存储到SharePreferences
	 */
